...
def main():
    ...
    ax1.text(ts[107], 0.50,
             "健常区間\n(学習用 215 窓)", fontsize=8.5, color="#2ca02c",
             ha="center", va="top")
    ax1.set_ylabel("RMS  [g]")
    ax1.set_title("NASA IMS Bearing 3 — 35 日間の振動と PIC 等価 d² 検出")
    ...
    ax2.set_ylabel("d²  (物理スケール換算, log)")
    ax2.set_xlabel("実験時刻 (UTC, 2003)")
    ...
    fig.tight_layout()
    out = FIG_DIR / "bearing3_detection.png"
